          ...
          <Draggable key={activity.id} draggableId={activity.id} index={index}>
            {(provided) => (
              <div
                ...
                className={`p-3 rounded-lg flex items-start justify-between group ${
                  isCompleted
              ...
              >
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="p-1 rounded-full bg-red-400/20 text-red-400 hover:bg-red-400/30 opacity-0 group-hover:opacity-100 transition-opacity"
                  >
                    <Trash2 size={18} />
                  </button>
                </div>
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr>
                    {DAYS.map((day, index) => (
                      <th key={day} 
                        className={`p-3 text-white border border-white/20 
                        ${hoveredDay !== null && index !== hoveredDay && selectedDay === null ? 'opacity-50 blur-sm' : ''}`}
                ...
                <tbody>
                  <tr>
                    {DAYS.map((_, dayIndex) => (
                      <td key={dayIndex} 
                        className={`p-3 border border-white/20 align-top 
                        ${hoveredDay !== null && dayIndex !== hoveredDay && selectedDay === null ? 'opacity-50 blur-sm' : ''}`}
